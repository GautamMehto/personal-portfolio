import{j as r}from"./index-Sgv-kmNM.js";function p({label:e,icon:n,path:a,className:t,download:i,external:o}){return r.jsxs("a",{href:a,...i&&{download:!0},...o&&{target:"_blank",rel:"noopener noreferrer"},className:` inline-block
